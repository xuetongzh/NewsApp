...
public class FragmentAdapter extends RecyclerView.Adapter<FragmentAdapter.ViewHolder> {
    ...
    //Constructor
    public FragmentAdapter(Context context, List<NewsBean> newsBeans) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_fragment, parent, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.newsFTitle.setText(newsBean.getNewsTitle());
        holder.newsFContent.setText(newsBean.getNewsContent());
    }
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private final TextView newsFTitle, newsFContent;

        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            imageView = (ImageView) itemView.findViewById(R.id.newsFImage);
            newsFTitle = (TextView) itemView.findViewById(R.id.newsFTitle);
            newsFContent = (TextView) itemView.findViewById(R.id.newsFContent);
    ...
    private FragmentAdapter.OnItemClickListener onItemClickListener;
